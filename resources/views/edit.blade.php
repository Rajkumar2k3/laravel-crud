            ...
            <div class="card-body">
                ...
                <form action="{{route('employee.update',$employee->id)}}" class="was-validated" method="POST">
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="number" name="phone" id="phone" class="form-control {{$errors->has('phone')?'is-invalid':''}}" value="{{$employee->phone}}" required>
                        @if($errors->has('phone'))
                        <span class="invalid-feedback">
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="checkbox" name="is_active" id="is_active" class="{{$errors->has('is_active')?'is-invalid':''}}" value="1"
                        {{$employee->is_active=='1'?'checked':''}} required>
